...
@section('content')
    ...
    <section class="page-title">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h4><i class="fa fa-id-card-o" aria-hidden="true"></i>  Profil</h4>
                    <hr class="divider" />
    ...
    <div class="row">
        <div class="col-md-12 ">
            <div class="card">
                <div class="card-body">
                    <h4><i class="fa fa-user-circle" aria-hidden="true"></i>  My Profile</h4>
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>Nama</td>
        ...
        <div class="col-md-12 mt-2">
            <div class="card">
                <div class="card-body">
                    <h4><i class="fa fa-pencil-square-o" aria-hidden="true"></i>  Edit Profile</h4>
