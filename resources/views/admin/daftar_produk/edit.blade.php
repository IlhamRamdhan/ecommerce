...
<!--begin::Entry-->
 ...
 <div class="content-header">
  ...
  <form action="/admin/daftar_produk/update" method="POST">
    {{ csrf_field() }}
  <div class="card card-custom card-stretch">
  <!--begin::Header-->
  <div class="card-header py-3">
  <div class="card-title align-items-start flex-column">
  <h3 class="card-label font-weight-bolder text-dark">Edit Fitur</h3>
  ...
  <div class="card-body">
    ...
    <div class="col-lg-10 col-xl-6">
        <input type="text" name="nama_barang" class="form-control form-control-lg form-control-solid" value="{{ $b->nama_barang }}">
    </div>
    </div>
    ...
    <div class="col-lg-10 col-xl-6">
    <textarea type="text" cols="30" rows="10" name="keterangan" class="form-control form-control-lg form-control-solid">{{ $b->keterangan }}</textarea>
    </div>
    </div>
    ...
    <div class="col-lg-10 col-xl-6">
    <input type="text" name="harga" class="form-control form-control-lg form-control-solid" value="{{ $b->harga }}">
    </div>
    </div>
    ...
    <div class="col-lg-10 col-xl-6">
    <input type="text" name="stok" class="form-control form-control-lg form-control-solid" value="{{ $b->stok }}">
    </div>
    </div>
    ...
    <div class="col-lg-10 col-xl-6">
        <input id="input-fa" type="file" value="{{ $b->gambar }}" class="form-control file form-control-lg form-control-solid" name="gambar" data-browse-on-zone-click="true" >
        <input type="hidden" value="{{ $b->gambar }}">
    </div>
    </div>
    <br>
