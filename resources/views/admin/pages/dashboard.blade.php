...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="m-0 text-dark"> <i class="fa fa-home fa-fw"></i> Dashboard</h1>
          <h5 class="mt-4 mb-2">Info Marketplace</h5>
          </div><!-- /.col -->
          <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-xl-3">
                                ...
                                <!--end::Svg Icon-->
                                        ...
                                        <span class="font-weight-bold text-muted font-size-sm">Daftar Produk</span>
                                    </div>
                                    <!--end::Body-->
                                </div>
                                <!--end::Stats Widget 29-->
                            ...
                            <div class="col-xl-3">
                                ...
                                <!--end::Svg Icon-->
                                        ...
                                        <span class="font-weight-bold text-white font-size-sm">Pembeli</span>
                                    </div>
                                    <!--end::Body-->
                                </div>
                                <!--end::Stats Widget 30-->
                            ...
                            <div class="col-xl-3">
                                ...
                                <!--end::Svg Icon-->
                                        ...
                                        <span class="font-weight-bold text-white font-size-sm">Jumlah Pesanan</span>
                                    </div>
                                    <!--end::Body-->
                                </div>
                                <!--end::Stats Widget 31-->
                            ...
                            <div class="col-xl-3">
                                ...
                                <!--end::Svg Icon-->
                                        ...
                                        <span class="card-title font-weight-bolder text-white font-size-h2 mb-0 mt-6 text-hover-primary d-block">30</span>
                                        <span class="font-weight-bold text-white font-size-sm">Detail Pesanan </span>
                                    </div>
                                    <!--end::Body-->
                                </div>
                                <!--end::Stats Widget 32-->
                                ...
                                <div class="card card-custom card-stretch gutter-b">
                                    ...
                                    <div class="card-header h-auto border-0">
                                        <div class="card-title py-5">
                                            <h3 class="card-label">
                                                <span class="d-block text-dark font-weight-bolder">Grafik Visitor</span>
